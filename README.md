Started from here: https://github.com/pulumi/automation-api-examples/tree/main/nodejs/inlineProgram-ts

Contains small code changes that point out gotcha's you need to take care of when making this an api.
